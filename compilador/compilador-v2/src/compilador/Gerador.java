		...
		if (no.getFilhos().size() == 1) {
			...
			if (valor2 != null) {
				if (valor2.getClasse().equals("ID")) {
					...
					System.out.println("ID - MOV EAX, " + valor2.getImagem());
					...
					System.out.println("CLI - MOV EAX, " + valor2.getImagem());
			...
			if (operador.equals("+")) {
				if (valor1.getClasse().equals("ID")) {
					...
					System.out.println("ID - ADD EAX, " + valor1.getImagem());
					...
					System.out.println("CLI - ADD EAX, " + valor1.getImagem());
	...
	private Object atrib(No no) {
		...
		if (operando != null) {
			if (operando.getClasse().equals("CLI")) {
				...
				System.out.println("OPER - MOV EAX, " + operando.getImagem());
			...
			System.out.println("NULL - MOV " + id.getImagem() + ", EAX");
			insereInstrucao(3, 1, simbolos.get(id.getIndice()).getMemoria(), 4, 1, 1);
		}
